...
CREATE TABLE `employees` (
  ...
  CONSTRAINT `employees_ibfk_1` FOREIGN KEY (`id_projects`) REFERENCES `projects` (`id_projects`)
...
INSERT INTO `employees` VALUES (2,'Ona',1),(3,'Petras',1),(4,'Laura',2),(5,'Tadas',3),(13,'Vilius',NULL);
...
INSERT INTO `projects` VALUES (1,'PHP kursai'),(2,'Java kursai'),(3,'JavaScript kursai'),(22,'React kursai');
...
-- Dump completed on 2021-03-22 18:17:16
